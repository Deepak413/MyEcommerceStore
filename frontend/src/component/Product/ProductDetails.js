    ...
    <Fragment>
      {productLoading ? (
        ...
        <>
              ...
              <div className="detailsBlock-3">
                ...
                <div className="detailsBlock-3-1">
                  <div className="detailsBlock-3-1-1">
                    <button readOnly onClick={decreseQuantity}>
                      -
                    </button>
                    <input readOnly type="number" value={quantity} />
                    <button readOnly onClick={increseQuantity}>
                      +
                    </button>
                  </div>
                  <button
                  ...
                  <button
                    ...
                    className="addToWishlistBtnOnDetailsPage"
          ...
          >
            <DialogTitle className="submitReviewHeading">
              Submit Review
            </DialogTitle>
            ...
            <DialogActions>
              <button
                className="submitReviewCancelBtn"
                onClick={submitReviewToggle}
              >
                CANCEL
              </button>
              <button
                className="submitReviewSubmitBtn"
